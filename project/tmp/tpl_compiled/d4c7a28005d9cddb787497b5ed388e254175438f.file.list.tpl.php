<?php /* Smarty version Smarty-3.0.6, created on 2012-03-14 16:53:05
         compiled from "E:\wamp\www\oa\project\applications\order\templates\order\list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:316024f605c71c468e3-17721814%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd4c7a28005d9cddb787497b5ed388e254175438f' => 
    array (
      0 => 'E:\\wamp\\www\\oa\\project\\applications\\order\\templates\\order\\list.tpl',
      1 => 1305682216,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '316024f605c71c468e3-17721814',
  'function' => 
  array (
  ),
...
<span style="width:300px;"><?php echo $_smarty_tpl->getVariable('page_title')->value;?>
 <font color="#006666"> &gt;&gt;Order Resource Center </font></span>
<ul class="ul2" id="order_navigation">
    <?php  $_smarty_tpl->tpl_vars['nav_item'] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('order_navigation')->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['nav_item']->key => $_smarty_tpl->tpl_vars['nav_item']->value){
?>
        <li>
            <a href="<?php echo smarty_function_url(array('action'=>$_smarty_tpl->tpl_vars['nav_item']->value['action']),$_smarty_tpl);?>
"><?php echo $_smarty_tpl->tpl_vars['nav_item']->value['name'];?>
</a>
            <?php if ($_smarty_tpl->tpl_vars['nav_item']->value['Children']){?>
            <dl>
                <?php  $_smarty_tpl->tpl_vars['nc'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['nav_item']->value['Children']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['nc']->key => $_smarty_tpl->tpl_vars['nc']->value){
?>
                    <dt>
                        <a href="<?php echo smarty_function_url(array('action'=>$_smarty_tpl->tpl_vars['nc']->value['action']),$_smarty_tpl);?>
"><?php echo $_smarty_tpl->tpl_vars['nc']->value['name'];?>
</a>
                    </dt>
                <?php }} ?>
            </dl>
    ...
    <?php }} ?>
    <?php if ($_smarty_tpl->getVariable('is_customer_service')->value){?>
        <li><a href="<?php echo smarty_function_url(array('action'=>"order/contacted"),$_smarty_tpl);?>
">我录入的所有订单</a></li>
    <?php }?>
</ul>
...
<table width="1248" cellspacing="0" cellpadding="0" border="0" class="table2">
	...
	<tr>
        ...
        <?php if ($_smarty_tpl->getVariable('paginator')->value['items'][0]['Seller']){?>
        ...
        <?php if ($_smarty_tpl->getVariable('operations')->value){?>
...
?>
            <tr align="center" ondblclick="location.href='<?php echo smarty_function_url(array('action'=>'order/detail'),$_smarty_tpl);?>
<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
'" class="trCol">

                <td><?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
</td>
                <td><?php echo $_smarty_tpl->tpl_vars['item']->value['CustomerService']['username'];?>
</td>
                <?php if ($_smarty_tpl->tpl_vars['item']->value['Seller']){?>
                <td><?php echo $_smarty_tpl->tpl_vars['item']->value['Seller']['username'];?>
</td>
                <?php }?>
                <td><?php echo $_smarty_tpl->tpl_vars['item']->value['subscribe_time'];?>
</td>
                <td><?php echo $_smarty_tpl->tpl_vars['item']->value['Customer']['company_name'];?>
</td>
                <td><?php echo $_smarty_tpl->tpl_vars['item']->value['Customer']['name'];?>
</td>
                <td><?php echo $_smarty_tpl->tpl_vars['item']->value['Customer']['telephone'];?>
</td>
                <td><?php echo $_smarty_tpl->tpl_vars['item']->value['Customer']['areas'];?>
</td>
                <?php if ($_smarty_tpl->tpl_vars['item']->value['Workflow']['state']){?>
                    <td align="center"><?php echo $_smarty_tpl->tpl_vars['item']->value['Workflow']['state'];?>
</td>
                <?php }else{ ?>
                    <td align="center"><?php echo $_smarty_tpl->tpl_vars['item']->value['Workflow']['alias'];?>
</td>
                <?php }?>
                
                <?php if ($_smarty_tpl->getVariable('operations')->value){?>
                    <td>
                        <?php if ($_smarty_tpl->getVariable('operations')->value['action']){?>
                            <a href="<?php echo smarty_function_url(array('action'=>$_smarty_tpl->getVariable('operations')->value['action']),$_smarty_tpl);?>
<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
/"><?php echo $_smarty_tpl->getVariable('operations')->value['label'];?>
</a>
                        <?php }else{ ?>
                            <?php  $_smarty_tpl->tpl_vars['opera'] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('operations')->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['opera']->key => $_smarty_tpl->tpl_vars['opera']->value){
?>
                                <a href="<?php echo smarty_function_url(array('action'=>$_smarty_tpl->tpl_vars['opera']->value['action']),$_smarty_tpl);?>
<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
/"><?php echo $_smarty_tpl->tpl_vars['opera']->value['label'];?>
</a>
                            <?php }} ?>
                        <?php }?>
                    </td>
        ...
        <tr>
            <td align="right" style="background:#f2f2f2; height:28px; padding-right:15px;" colspan="11">
                <?php $_template = new Smarty_Internal_Template("paginator.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null);
$_template->properties['nocache_hash']  = '316024f605c71c468e3-17721814';
$_tpl_stack[] = $_smarty_tpl; $_smarty_tpl = $_template;?>
<?php /* Smarty version Smarty-3.0.6, created on 2012-03-14 16:53:06
